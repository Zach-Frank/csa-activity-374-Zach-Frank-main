...
public class HorseBarn
{
  ...
  public static ArrayList<Horse> next(ArrayList<Horse> original)
  {
    ArrayList<Horse> h = new ArrayList<Horse>();
    ArrayList<Horse> copy = new ArrayList<Horse>();
    for (Horse ho : original)
      copy.add(ho);
    ...
    {
      int randIndex = (int)(Math.random() * (length - i));
      h.add(original.remove(randIndex));
    }
    return h;
  }
}
